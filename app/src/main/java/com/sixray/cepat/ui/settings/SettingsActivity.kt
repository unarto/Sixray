package com.sixray.cepat.ui.settings
...
import com.sixray.cepat.AppConfig.VPN
import com.sixray.cepat.R
import com.sixray.cepat.handler.MmkvManager.rememberMmkvBool
import com.sixray.cepat.handler.MmkvManager.rememberMmkvString
import com.sixray.cepat.handler.SettingsChangeManager
import com.sixray.cepat.root.RootManager
import com.sixray.cepat.ui.base.BaseComponentActivity
import com.sixray.cepat.ui.compose.AppTopBar
import com.sixray.cepat.ui.compose.CollapsiblePreferenceGroupHeader
import com.sixray.cepat.ui.compose.SettingsEditItem
import com.sixray.cepat.ui.compose.SettingsListItem
import com.sixray.cepat.ui.compose.SettingsMenuItem
import com.sixray.cepat.ui.compose.SettingsSwitchItem
import com.sixray.cepat.ui.compose.ThemeManager
import com.sixray.cepat.ui.compose.verticalScrollbar
...
fun SettingsScreen(
    ...
    var vpnDns by rememberMmkvString(AppConfig.PREF_VPN_DNS, AppConfig.DNS_VPN)
    ...
    var remoteDns by rememberMmkvString(AppConfig.PREF_REMOTE_DNS, AppConfig.DNS_PROXY)
    var domesticDns by rememberMmkvString(AppConfig.PREF_DOMESTIC_DNS, AppConfig.DNS_DIRECT)
    var dnsHosts by rememberMmkvString(AppConfig.PREF_DNS_HOSTS, AppConfig.DNS_HOSTS_DEFAULT)
