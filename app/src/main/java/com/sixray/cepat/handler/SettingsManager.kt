...
import com.sixray.cepat.AppConfig.ANG_PACKAGE
import com.sixray.cepat.AppConfig.DEFAULT_SUBSCRIPTION_ID
import com.sixray.cepat.AppConfig.GEOIP_PRIVATE
import com.sixray.cepat.AppConfig.GEOSITE_PRIVATE
import com.sixray.cepat.AppConfig.TAG_DIRECT
import com.sixray.cepat.AppConfig.VPN
import com.sixray.cepat.dto.V2rayConfig
import com.sixray.cepat.dto.entities.ProfileItem
import com.sixray.cepat.dto.entities.RulesetItem
import com.sixray.cepat.dto.entities.SubscriptionItem
import com.sixray.cepat.enums.EConfigType
import com.sixray.cepat.enums.Language
import com.sixray.cepat.enums.RoutingType
import com.sixray.cepat.enums.VpnInterfaceAddressConfig
import com.sixray.cepat.extension.moveItem
import com.sixray.cepat.handler.MmkvManager.decodeAllServerList
import com.sixray.cepat.handler.MmkvManager.decodeServerConfig
import com.sixray.cepat.handler.MmkvManager.decodeSubsList
import com.sixray.cepat.handler.MmkvManager.decodeSubscription
import com.sixray.cepat.handler.MmkvManager.encodeSubscription
import com.sixray.cepat.handler.MmkvManager.removeSubscription
...
object SettingsManager {
    ...
    private fun ensureDefaultSettings() {
        ...
        ensureDefaultValue(AppConfig.PREF_DNS_HOSTS, AppConfig.DNS_HOSTS_DEFAULT)
